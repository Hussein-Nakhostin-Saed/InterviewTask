...
namespace Services
{
	public static class ApiService : object
    {
        ...
        #region public static IQueryable<T> CustomInclude<T>(this DbSet<T> dbset, params string[] properties) where T : class
        public static IQueryable<T> CustomInclude<T>(this DbSet<T> dbset, params string[] properties) where T : class
        {
        ...
        #endregion /public static IQueryable<T> CustomInclude<T>(this DbSet<T> dbset, params string[] properties) where T : class
    }
}